      ...
      <div>
        ...
        <div id="page-wrapper" className="gray-bg dashbard-1">
          ...
          <h2 id="category-heading">
            <Translate contentKey="studentexchangeApp.category.home.title">Categories</Translate>
            <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
              <FontAwesomeIcon icon="plus" />
              &nbsp;
              <Translate contentKey="studentexchangeApp.category.home.createLabel">Create new Category</Translate>
            </Link>
          </h2>
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('name')}>
                    <Translate contentKey="studentexchangeApp.category.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('createAt')}>
                    <Translate contentKey="studentexchangeApp.category.createAt">Create At</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('updateAt')}>
                    <Translate contentKey="studentexchangeApp.category.updateAt">Update At</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>

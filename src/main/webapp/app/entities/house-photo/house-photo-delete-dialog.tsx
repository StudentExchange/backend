...
import { getEntity, deleteEntity } from './house-photo.reducer';

export interface IHousePhotoDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export class HousePhotoDeleteDialog extends React.Component<IHousePhotoDeleteDialogProps> {
  componentDidMount() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-housePhoto" color="danger" onClick={this.confirmDelete}>

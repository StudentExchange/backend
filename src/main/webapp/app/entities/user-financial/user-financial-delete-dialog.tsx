...
import { getEntity, deleteEntity } from './user-financial.reducer';

export interface IUserFinancialDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export class UserFinancialDeleteDialog extends React.Component<IUserFinancialDeleteDialogProps> {
  componentDidMount() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-userFinancial" color="danger" onClick={this.confirmDelete}>

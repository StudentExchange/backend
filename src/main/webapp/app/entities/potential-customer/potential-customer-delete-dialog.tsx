...
import { getEntity, deleteEntity } from './potential-customer.reducer';

export interface IPotentialCustomerDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export class PotentialCustomerDeleteDialog extends React.Component<IPotentialCustomerDeleteDialogProps> {
  componentDidMount() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-potentialCustomer" color="danger" onClick={this.confirmDelete}>

...
import { getEntity, deleteEntity } from './service-fee.reducer';

export interface IServiceFeeDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export class ServiceFeeDeleteDialog extends React.Component<IServiceFeeDeleteDialogProps> {
  componentDidMount() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-serviceFee" color="danger" onClick={this.confirmDelete}>

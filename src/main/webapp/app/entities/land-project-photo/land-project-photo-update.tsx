...
export interface ILandProjectPhotoUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}
...
const mapStateToProps = (storeState: IRootState) => ({
  ...
  updateSuccess: storeState.landProjectPhoto.updateSuccess
});
